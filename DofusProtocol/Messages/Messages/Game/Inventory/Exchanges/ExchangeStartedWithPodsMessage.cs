...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class ExchangeStartedWithPodsMessage : ExchangeStartedMessage
    {
        ...
        public ExchangeStartedWithPodsMessage(sbyte exchangeType, double firstCharacterId,
            uint firstCharacterCurrentWeight, uint firstCharacterMaxWeight, double secondCharacterId,
            uint secondCharacterCurrentWeight, uint secondCharacterMaxWeight)
        {
