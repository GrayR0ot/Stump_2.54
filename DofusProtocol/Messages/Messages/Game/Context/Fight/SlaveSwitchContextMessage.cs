...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class SlaveSwitchContextMessage : Message
    {
        ...
        public SlaveSwitchContextMessage(double masterId, double slaveId, SpellItem[] slaveSpells,
            CharacterCharacteristicsInformations slaveStats, Shortcut[] shortcuts)
        {
            MasterId = masterId;
            SlaveId = slaveId;
