...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class PartyInvitationDungeonMessage : PartyInvitationMessage
    {
        ...
        public PartyInvitationDungeonMessage(uint partyId, sbyte partyType, string partyName, sbyte maxParticipants,
            ulong fromId, string fromName, ulong toId, ushort dungeonId)
        {
            PartyId = partyId;
            PartyType = partyType;
            PartyName = partyName;
