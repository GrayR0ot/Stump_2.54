...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class AbstractPartyMemberInFightMessage : AbstractPartyMessage
    {
        ...
        public AbstractPartyMemberInFightMessage(uint partyId, sbyte reason, ulong memberId, int memberAccountId,
            string memberName, ushort fightId, short timeBeforeFightStart)
        {
            PartyId = partyId;
            Reason = reason;
            MemberId = memberId;
