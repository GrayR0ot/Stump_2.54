...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class PartyMemberInBreachFightMessage : AbstractPartyMemberInFightMessage
    {
        ...
        public PartyMemberInBreachFightMessage(uint partyId, sbyte reason, ulong memberId, int memberAccountId,
            string memberName, ushort fightId, short timeBeforeFightStart, uint floor, sbyte room)
        {
            PartyId = partyId;
            Reason = reason;
            MemberId = memberId;
