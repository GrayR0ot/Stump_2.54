...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class PartyJoinMessage : AbstractPartyMessage
    {
        ...
        public PartyJoinMessage(uint partyId, sbyte partyType, ulong partyLeaderId, sbyte maxParticipants,
            PartyMemberInformations[] members, PartyGuestInformations[] guests, bool restricted, string partyName)
        {
            PartyId = partyId;
            PartyType = partyType;
