...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class MapComplementaryInformationsDataInHavenBagMessage : MapComplementaryInformationsDataMessage
    {
        ...
        public MapComplementaryInformationsDataInHavenBagMessage(ushort subAreaId, double mapId,
            ...
            CharacterMinimalInformations ownerInformations, sbyte theme, sbyte roomId, sbyte maxRoomId)
        {
            SubAreaId = subAreaId;
            MapId = mapId;
            Houses = houses;
