...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class GameActionFightLifeAndShieldPointsLostMessage : GameActionFightLifePointsLostMessage
    {
        ...
        public GameActionFightLifeAndShieldPointsLostMessage(ushort actionId, double sourceId, double targetId,
            uint loss, uint permanentDamages, int elementId, ushort shieldLoss)
        {
            ActionId = actionId;
            SourceId = sourceId;
            TargetId = targetId;
