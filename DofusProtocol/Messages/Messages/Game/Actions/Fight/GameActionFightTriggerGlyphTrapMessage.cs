...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class GameActionFightTriggerGlyphTrapMessage : AbstractGameActionMessage
    {
        ...
        public GameActionFightTriggerGlyphTrapMessage(ushort actionId, double sourceId, short markId,
            ushort markImpactCell, double triggeringCharacterId, ushort triggeredSpellId)
        {
            ActionId = actionId;
            SourceId = sourceId;
            MarkId = markId;
