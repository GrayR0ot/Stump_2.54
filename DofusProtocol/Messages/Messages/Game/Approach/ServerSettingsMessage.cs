...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class ServerSettingsMessage : Message
    {
        ...
        public ServerSettingsMessage(bool isMonoAccount, bool hasFreeAutopilot, string lang, sbyte community,
            sbyte gameType, ushort arenaLeaveBanTime, int itemMaxLevel)
        {
