...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class ChatServerCopyWithObjectMessage : ChatServerCopyMessage
    {
        ...
        public ChatServerCopyWithObjectMessage(sbyte channel, string content, int timestamp, string fingerprint,
            ulong receiverId, string receiverName, ObjectItem[] objects)
        {
            Channel = channel;
            Content = content;
            Timestamp = timestamp;
