...
namespace Stump.DofusProtocol.Messages
{
    ...
    public class ChatServerMessage : ChatAbstractServerMessage
    {
        ...
        public ChatServerMessage(sbyte channel, string content, int timestamp, string fingerprint, double senderId,
            string senderName, string prefix, int senderAccountId)
        {
            Channel = channel;
            Content = content;
            Timestamp = timestamp;
