...
namespace Stump.DofusProtocol.D2oClasses.Tools.Ele
{
    ...
    {
        private readonly Dictionary<int, int> m_indexes = new Dictionary<int, int>();
        ...
        public static EleInstance ReadFromStream(BigEndianReader reader)
        {
            ...
            {
                if (instance.Version >= 9) skypLen = reader.ReadUShort();
            ...
            if (instance.Version >= 8)
            {
                ...
                for (var i = 0; i < gfxCount; i++) instance.GfxJpgMap.Add(reader.ReadInt(), true);
            }
