...
namespace Stump.DofusProtocol.Types
{
    ...
    public class GuildMember : CharacterMinimalInformations
    {
        ...
        public GuildMember(ulong objectId, string name, ushort level, bool sex, bool havenBagShared, sbyte breed,
            ushort rank, ulong givenExperience, sbyte experienceGivenPercent, uint rights, sbyte connected,
            sbyte alignmentSide, ushort hoursSinceLastConnection, ushort moodSmileyId, int accountId,
            int achievementPoints, PlayerStatus status)
        {
            ObjectId = objectId;
            Name = name;
            Level = level;
