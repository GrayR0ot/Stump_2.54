...
namespace Stump.DofusProtocol.Types
{
    ...
    public class TaxCollectorInformations
    {
        ...
        public TaxCollectorInformations(double uniqueId, ushort firtNameId, ushort lastNameId,
            ...
            sbyte state, EntityLook look, TaxCollectorComplementaryInformations[] complements)
        {
            UniqueId = uniqueId;
        ...
        public virtual void Deserialize(IDataReader reader)
        {
            ...
            {
                var objectToAdd =
                    ProtocolTypeManager.GetInstance<TaxCollectorComplementaryInformations>(reader.ReadShort());
