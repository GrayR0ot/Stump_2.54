...
namespace Stump.DofusProtocol.Types
{
    ...
    public class ActorExtendedAlignmentInformations : ActorAlignmentInformations
    {
        ...
        public ActorExtendedAlignmentInformations(sbyte alignmentSide, sbyte alignmentValue, sbyte alignmentGrade,
            double characterPower, ushort honor, ushort honorGradeFloor, ushort honorNextGradeFloor, sbyte aggressable)
        {
