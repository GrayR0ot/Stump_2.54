...
namespace Stump.DofusProtocol.Types
{
    ...
    public class CharacterToRemodelInformations : CharacterRemodelingInformation
    {
        ...
        public CharacterToRemodelInformations(ulong objectId, string name, sbyte breed, bool sex, ushort cosmeticId,
            int[] colors, sbyte possibleChangeMask, sbyte mandatoryChangeMask)
        {
            ObjectId = objectId;
            Name = name;
            Breed = breed;
