...
namespace Stump.DofusProtocol.Types
{
    ...
    public class CharacterHardcoreOrEpicInformations : CharacterBaseInformations
    {
        ...
        public CharacterHardcoreOrEpicInformations(ulong objectId, string name, ushort level, EntityLook entityLook,
            sbyte breed, bool sex, sbyte deathState, ushort deathCount, ushort deathMaxLevel)
        {
            ObjectId = objectId;
            Name = name;
            Level = level;
