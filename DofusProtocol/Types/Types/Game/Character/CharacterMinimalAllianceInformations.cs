...
namespace Stump.DofusProtocol.Types
{
    ...
    public class CharacterMinimalAllianceInformations : CharacterMinimalGuildInformations
    {
        ...
        public CharacterMinimalAllianceInformations(ulong objectId, string name, ushort level, EntityLook entityLook,
            sbyte breed, BasicGuildInformations guild, BasicAllianceInformations alliance)
        {
            ObjectId = objectId;
            Name = name;
            Level = level;
