...
namespace Stump.DofusProtocol.Types
{
    ...
    public class ObjectEffectMount : ObjectEffect
    {
        ...
        public ObjectEffectMount(ushort actionId, bool sex, bool isRideable, bool isFeconded, bool isFecondationReady,
            ulong objectId, ulong expirationDate, uint model, string name, string owner, sbyte level,
            int reproductionCount, uint reproductionCountMax, ObjectEffectInteger[] effects, uint[] capacities)
        {
            ActionId = actionId;
            Sex = sex;
