...
namespace Stump.DofusProtocol.Types
{
    ...
    public class FightTriggeredEffect : AbstractFightDispellableEffect
    {
        ...
        public FightTriggeredEffect(uint uid, double targetId, short turnDuration, sbyte dispelable, ushort spellId,
            uint effectId, uint parentBoostUid, int param1, int param2, int param3, short delay)
        {
            Uid = uid;
            TargetId = targetId;
