...
namespace Stump.DofusProtocol.Types
{
    ...
    public class FightTemporarySpellImmunityEffect : AbstractFightDispellableEffect
    {
        ...
        public FightTemporarySpellImmunityEffect(uint uid, double targetId, short turnDuration, sbyte dispelable,
            ushort spellId, uint effectId, uint parentBoostUid, int immuneSpellId)
        {
            Uid = uid;
            TargetId = targetId;
