...
namespace Stump.DofusProtocol.Types
{
    ...
    public class PartyEntityMemberInformation : PartyEntityBaseInformation
    {
        ...
        public PartyEntityMemberInformation(sbyte indexId, sbyte entityModelId, EntityLook entityLook,
            ushort initiative, uint lifePoints, uint maxLifePoints, ushort prospecting, byte regenRate)
        {
            IndexId = indexId;
