...
namespace Stump.DofusProtocol.Types
{
    ...
    public class PartyMemberArenaInformations : PartyMemberInformations
    {
        ...
        public PartyMemberArenaInformations(ulong objectId, string name, ushort level, EntityLook entityLook,
            sbyte breed, bool sex, uint lifePoints, uint maxLifePoints, ushort prospecting, byte regenRate,
            ushort initiative, sbyte alignmentSide, short worldX, short worldY, double mapId, ushort subAreaId,
            PlayerStatus status, PartyEntityBaseInformation[] entities, ushort rank)
        {
            ObjectId = objectId;
            Name = name;
            Level = level;
