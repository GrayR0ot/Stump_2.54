...
namespace Stump.DofusProtocol.Types
{
    ...
    public class PartyInvitationMemberInformations : CharacterBaseInformations
    {
        ...
        public PartyInvitationMemberInformations(ulong objectId, string name, ushort level, EntityLook entityLook,
            sbyte breed, bool sex, short worldX, short worldY, double mapId, ushort subAreaId,
