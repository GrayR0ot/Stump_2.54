...
namespace Stump.DofusProtocol.Types
{
    ...
    public class LeagueFriendInformations : AbstractContactInformations
    {
        ...
        public LeagueFriendInformations(int accountId, string accountName, ulong playerId, string playerName,
            sbyte breed, bool sex, ushort level, short leagueId, short totalLeaguePoints, int ladderPosition)
        {
            AccountId = accountId;
