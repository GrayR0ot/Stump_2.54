...
namespace Stump.DofusProtocol.Types
{
    ...
    public class FightResultTaxCollectorListEntry : FightResultFighterListEntry
    {
        ...
        public FightResultTaxCollectorListEntry(ushort outcome, sbyte wave, FightLoot rewards, double objectId,
            bool alive, byte level, BasicGuildInformations guildInfo, int experienceForGuild)
        {
            Outcome = outcome;
            Wave = wave;
            Rewards = rewards;
