...
namespace Stump.DofusProtocol.Types
{
    ...
    public class GameFightFighterEntityLightInformation : GameFightFighterLightInformations
    {
        ...
        public GameFightFighterEntityLightInformation(bool sex, bool alive, double objectId, sbyte wave, ushort level,
            sbyte breed, sbyte entityModelId, double masterId)
        {
            Sex = sex;
            Alive = alive;
            ObjectId = objectId;
