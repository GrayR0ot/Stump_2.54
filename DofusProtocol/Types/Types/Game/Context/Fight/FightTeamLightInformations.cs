...
namespace Stump.DofusProtocol.Types
{
    ...
    public class FightTeamLightInformations : AbstractFightTeamInformations
    {
        ...
        public FightTeamLightInformations(sbyte teamId, double leaderId, sbyte teamSide, sbyte teamTypeId,
            sbyte nbWaves, bool hasFriend, bool hasGuildMember, bool hasAllianceMember, bool hasGroupMember,
            bool hasMyTaxCollector, sbyte teamMembersCount, uint meanLevel)
        {
            TeamId = teamId;
            LeaderId = leaderId;
            TeamSide = teamSide;
