...
namespace Stump.DofusProtocol.Types
{
    ...
    public class AccountHouseInformations : HouseInformations
    {
        ...
        public AccountHouseInformations(uint houseId, ushort modelId, HouseInstanceInformations houseInfos,
            short worldX, short worldY, double mapId, ushort subAreaId)
        {
            HouseId = houseId;
            ModelId = modelId;
