...
namespace Stump.DofusProtocol.Types
{
    ...
    public class GameServerInformations
    {
        ...
        public GameServerInformations(bool isMonoAccount, bool isSelectable, ushort objectId, sbyte type, sbyte status,
            sbyte completion, sbyte charactersCount, sbyte charactersSlots, double date)
        {
