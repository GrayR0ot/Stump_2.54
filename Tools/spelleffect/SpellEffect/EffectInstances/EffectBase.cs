...
namespace SpellEffect.EffectInstances
{
    ...
    {
        private static readonly Dictionary<char, SpellTargetType> m_targetsMapping =
            new Dictionary<char, SpellTargetType>
            {
        ...
        private static readonly Dictionary<string, BuffTriggerType> m_triggersMapping =
            new Dictionary<string, BuffTriggerType>
            {
        ...
        private int m_delay;
        private int m_dispellable;
        private int m_duration;
        private int m_effectElement;
        private bool m_forClientOnly;
        private int m_group;
        ...
        [NonSerialized] private List<string> m_targets = new List<string>();
        ...
        [NonSerialized] private List<string> m_triggersbuff = new List<string>();
        ...
        {
            get => m_zoneSize >= 63 ? (byte) 63 : (byte) m_zoneSize;
            set
            {
                m_zoneSize = value;
                IsDirty = true;
        ...
        {
            get => m_zoneMinSize >= 63 ? (byte) 63 : (byte) m_zoneMinSize;
            set
            {
                m_zoneMinSize = value;
                IsDirty = true;
        ...
        protected void ParseRawZone(string rawZone)
        {
            ...
            byte size = 0;
            byte minSize = 0;
            var zoneEfficiency = 0;
            var zoneMaxEfficiency = 0;
