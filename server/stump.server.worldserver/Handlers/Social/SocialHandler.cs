...
namespace Stump.Server.WorldServer.Handlers.Social
{
    public class SocialHandler : WorldHandlerContainer
    {
        ...
        public static void HandleContactLookRequestByIdMessage(WorldClient client,
            ContactLookRequestByIdMessage message)
        {
        ...
        public static void HandleContactLookRequestByNameMessage(WorldClient client,
            ContactLookRequestByNameMessage message)
        {
        ...
        {
            client.Send(new ContactLookMessage((uint) requestId, character.Name, (ulong) character.Id,
                character.Look.GetEntityLook()));
        }
