...
namespace Stump.Server.WorldServer.Handlers.Mounts
{
    public class MountHandler : WorldHandlerContainer
    {
        ...
        public static void HandleMountToggleRidingRequestMessage(WorldClient client,
            MountToggleRidingRequestMessage message)
        {
        ...
        public static void HandleMountInformationRequestMessage(WorldClient client,
            MountInformationRequestMessage message)
        {
        ...
        public static void HandleMountHarnessColorsUpdateRequestMessage(WorldClient client,
            MountHarnessColorsUpdateRequestMessage message)
        {
            if (!client.Character.HasEquippedMount())
                return;
        ...
        public static void HandleMountHarnessDissociateRequestMessage(WorldClient client,
            MountHarnessDissociateRequestMessage message)
        {
            var harness = client.Character.EquippedMount?.Harness;

            if (harness != null)
                client.Character.Inventory.MoveItem(harness,
