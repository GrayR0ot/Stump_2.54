...
namespace Stump.Server.WorldServer.Handlers.Breach
{
    public class BreachHandler : WorldHandlerContainer
    {
            ...
            BreachInvitationAnswerMessage message)
        {
            if (client.Character.songesGroupInvitation != null)
            {
                if (message.Accept)
                {
                    ...
                    client.Send(new BreachInvitationCloseMessage(client.Character.songesOwner.GetCharacterMinimalInformations()));
                    client.Character.songesOwner.Client.Send(new BreachInvitationResponseMessage(client.Character.GetCharacterMinimalInformations(), true));
            ...
            BreachInvitationRequestMessage message)
        {
            ...
            {
                Character target = World.Instance.GetCharacter((int) message.Guest);
            ...
            BreachRewardBuyMessage message)
        {
            ...
            {
                for (int index = 0; index < client.Character.songesBuyables.Length; index++)
                {
                    BreachReward buyable = client.Character.songesBuyables[index];
                            ...
                            switch (buyable.ObjectId)
                            {
                                ...
                                case 6:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 126, 10));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR LUCK
                                case 7:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 123, 10));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR AGILITY
                                case 91:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 119, 10));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR STRENGTH
                                case 92:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 118, 10));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR VITALITY
                                case 93:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 125, 25));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR POWER
                                case 94:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 138, 10));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR AP ATTACK
                                case 95:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 410, 1));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR AM ATTACK
                                case 96:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 412, 1));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR TACKLE LEAK
                                case 99:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 752, 1));
                                    client.Character.songesBudget -= 300;
                                    break;
                                //MINOR TACKLE BLOCK
                                case 100:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 753, 1));
                                    client.Character.songesBudget -= 300;
                                    break;
                                ///MEDIUM INTELLIGENCY
                                case 103:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 126, 25));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM LUCK
                                case 104:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 123, 25));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM AGILITY
                                case 105:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 119, 25));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM STRENGTH
                                case 106:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 118, 25));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM VITALITY
                                case 107:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 125, 50));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM POWER
                                case 108:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 138, 20));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM AP ATTACK
                                case 109:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 410, 2));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM AM ATTACK
                                case 110:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 412, 2));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM TACKLE LEAK
                                case 113:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 752, 2));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ///MEDIUM TACKLE BLOCK
                                case 114:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 753, 2));
                                    client.Character.songesBudget -= 600;
                                    break;
                                ...
                                case 117:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 126, 50));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR LUCK
                                case 118:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 123, 50));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR AGILITY
                                case 119:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 119, 50));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR STRENGTH
                                case 120:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 118, 50));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR VITALITY
                                case 121:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 125, 100));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR POWER
                                case 122:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 138, 40));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR AP ATTACK
                                case 123:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 410, 4));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR AM ATTACK
                                case 124:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 412, 4));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR TACKLE LEAK
                                case 127:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 752, 4));
                                    client.Character.songesBudget -= 900;
                                    break;
                                ///MAJOR TACKLE BLOCK
                                case 128:
                                    client.Character.songesBoosts =
                                        client.Character.songesBoosts.Add(new ObjectEffectInteger((ushort) 753, 4));
                                    client.Character.songesBudget -= 900;
                                    break;
                                default:
                                    break;
