...
namespace Stump.Server.WorldServer.Handlers.Shortcuts
{
    public class ShortcutHandler : WorldHandlerContainer
    {
        ...
        public static void HandleShortcutBarRemoveRequestMessage(WorldClient client,
        ...
        public static void HandleShortcutBarSwapRequestMessage(WorldClient client,
            ShortcutBarSwapRequestMessage message)
        {
            client.Character.Shortcuts.SwapShortcuts((ShortcutBarEnum) message.BarType, message.FirstSlot,
                message.SecondSlot);
        }
        ...
        public static void SendShortcutBarContentMessage(WorldClient client, IEnumerable<Shortcut> shortcuts,
            ShortcutBarEnum barType)
        {
            client.Send(new ShortcutBarContentMessage((sbyte) barType, shortcuts.ToArray()));
        }

        public static void SendShortcutBarRefreshMessage(IPacketReceiver client, ShortcutBarEnum barType,
            Database.Shortcuts.Shortcut shortcut)
        {
