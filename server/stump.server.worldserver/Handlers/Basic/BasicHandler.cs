...
namespace Stump.Server.WorldServer.Handlers.Basic
{
    public class BasicHandler : WorldHandlerContainer
    {
        ...
        public static void HandleBasicWhoAmIRequestMessage(WorldClient client, BasicWhoAmIRequestMessage message)
        {
            ...
            client.Send(new BasicWhoIsMessage(
                ...
                character.GuildMember == null
                    ? new AbstractSocialGroupInfos[0]
                    : new[] {character.Guild.GetBasicGuildInformations()},
                character.IsInFight()
                    ? (sbyte) PlayerStateEnum.GAME_TYPE_FIGHT
        ...
        public static void SendTextInformationMessage(IPacketReceiver client, TextInformationTypeEnum msgType,
            short msgId,
            ...
            params object[] arguments)
        {
            client.Send(new TextInformationMessage((sbyte) msgType, msgId,
                arguments.Select(entry => entry.ToString()).ToArray()));
        }
        ...
        public static void SendSystemMessageDisplayMessage(IPacketReceiver client, bool hangUp, short msgId,
