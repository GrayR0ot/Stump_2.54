...
namespace Stump.Server.WorldServer.Handlers.Context
{
    public partial class ContextHandler : WorldHandlerContainer
    {
        ...
        public static void HandleGameRolePlayArenaFightAnswerMessage(WorldClient client,
        ...
        public static void HandleGameRolePlayArenaRegisterMessage(WorldClient client,
            GameRolePlayArenaRegisterMessage message)
        {
            if (client.Character.ArenaParty != null)
            {
                ...
                {
                    client.Character.SendServerMessage("Não foi possível completar a requisição.", Color.DarkOrange);
                    return;
                }
        ...
        public static void HandleGameRolePlayArenaUnregisterMessage(WorldClient client,
            ...
            int delay)
        {
            ...
            client.Send(new GameRolePlayArenaFightPropositionMessage((ushort) popup.Team.Fight.Id, members.ToArray(),
                (ushort) delay));
        }

        public static void SendGameRolePlayArenaFighterStatusMessage(IPacketReceiver client, int fightId,
            Character character, bool accepted)
        {
            client.Send(new GameRolePlayArenaFighterStatusMessage((ushort) fightId, character.Id, accepted));
        }

        public static void SendGameRolePlayArenaRegistrationStatusMessage(IPacketReceiver client, bool registred,
            PvpArenaStepEnum step, PvpArenaTypeEnum type)
        {
