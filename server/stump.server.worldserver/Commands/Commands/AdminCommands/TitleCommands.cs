...
namespace Stump.Server.WorldServer.Commands.Commands
{
    public class AddRemoveTitleCommand : AddRemoveCommand
    {
        ...
        public override void ExecuteAdd(TriggerBase trigger)
        {
            ...
            {
                foreach (var title in TinselManager.Instance.Titles) target.AddTitle(title.Key);
        ...
        public override void ExecuteRemove(TriggerBase trigger)
        {
            ...
            if (trigger.Get<bool>("all"))
            {
                foreach (var title in TinselManager.Instance.Titles) target.RemoveTitle(title.Key);
                target.ResetTitle();
    ...
    public class AddRemoveOrnamentCommand : AddRemoveCommand
    {
        ...
        public override void ExecuteAdd(TriggerBase trigger)
        {
            ...
            if (trigger.Get<bool>("all"))
            {
                foreach (var title in TinselManager.Instance.Ornaments) target.AddOrnament(title.Key);
