...
namespace Stump.Server.WorldServer.Commands.Commands
{
        ...
        public override void Execute(GameTrigger trigger)
        {
            ...
            if (blue == null || blue.Length == 0)
                ...
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Blue.ToArgb(),
                    blue.Select(x => x.Id).Select(x => (ushort) x)));
            ...
            if (red == null || red.Length == 0)
                ...
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Red.ToArgb(),
                    red.Select(x => x.Id).Select(x => (ushort) x)));
        }
    }
    ...
    public class FightPlacementAddCommand : InGameSubCommand
    {
        ...
        public override void Execute(GameTrigger trigger)
        {
            ...
            {
                if (blue)
                    trigger.Character.Map.Record.BlueFightCells =
                        trigger.Character.Map.Record.BlueFightCells.Add(cell.Id);
                else
                    trigger.Character.Map.Record.RedFightCells =
                        trigger.Character.Map.Record.RedFightCells.Add(cell.Id);
