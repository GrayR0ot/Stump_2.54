...
namespace Stump.Server.WorldServer.Commands.Commands
{
    ...
    public class DungeonEnableCommand : SubCommand
    {
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            else
            {
                ...
                foreach (var submap in subarea.Maps) submap.DisableClassicalMonsterSpawns();
            }
    ...
    public class DungeonDisableCommand : SubCommand
    {
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            foreach (var map in subarea.Maps) map.EnableClassicalMonsterSpawns();
