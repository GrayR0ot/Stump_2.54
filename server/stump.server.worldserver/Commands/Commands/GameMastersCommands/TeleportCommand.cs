...
namespace Stump.Server.WorldServer.Commands.Commands
{
    public class GoPosCommand : TargetCommand
    {
        public GoPosCommand()
        {
            ...
            AddParameter("superarea", "area", "Super area containing the map (e.g 0 is continent, 3 is incarnam)",
                isOptional: true, converter: ParametersConverter.SuperAreaConverter);
    ...
    public class GoNameCommand : CommandBase
    {
        public GoNameCommand()
        {
            ...
            AddParameter("from", "from", "The character that teleport", isOptional: true,
