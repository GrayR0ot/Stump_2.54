...
namespace Stump.Server.WorldServer.Database.Achievements
{
    ...
    public class AchievementTemplate : IAutoGeneratedRecord, ISaveIntercepter, IAssignedByD2O
    {
        ...
        [Ignore] public string Name => m_name ?? (m_name = Singleton<TextManager>.Instance.GetText(NameId));
        ...
        public string Description =>
            m_description ?? (m_description = Singleton<TextManager>.Instance.GetText(DescriptionId));
        ...
        [Ignore] public AchievementObjectiveRecord[] Objectives { get; private set; }
        ...
        [Ignore] public AchievementRewardRecord[] Rewards { get; private set; }
        ...
        public int GetKamasReward(WorldClient client)
        {
            ...
            return (int) ((Math.Pow(ratio, 2) + 20 * ratio - 20) * KamasRatio * Rates.KamasRate);
        }
        ...
        public int GetExperienceReward(WorldClient client)
        {
            ...
            var vip = 1.0f;
            if (client.WorldAccount.Vip >= 1) vip = Rates.VipBonusXp;
            return (int) (GetFixeExperienceReward(lvl, 1, ExperienceRatio) * Rates.XpRate * vip);
        }
