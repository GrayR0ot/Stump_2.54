...
namespace Stump.Server.WorldServer.Database.Mounts
{
    public class MountRecordRelator
    {
        ...
        public static string FindByOwnerStabled =
            "SELECT * FROM mounts WHERE OwnerId = {0} AND IsInStable = 1 AND PaddockId IS NOT NULL";
        ...
        public static string DeleteStoredSince =
            "DELETE FROM mounts WHERE StoredSince IS NOT NULL AND StoredSince < \"{0}\"";
    }
    ...
    public class MountRecord : AutoAssignedRecord<MountRecord>, IJoined, IAutoGeneratedRecord
    {
        ...
        [Index] public int? OwnerId { get; set; }

        [NullString] public string OwnerName { get; set; }

        [Index] public int? PaddockId { get; set; }
