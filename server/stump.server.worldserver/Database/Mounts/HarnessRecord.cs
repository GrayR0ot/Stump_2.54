...
namespace Stump.Server.WorldServer.Database.Mounts
{
    ...
    public class HarnessRecord : IAutoGeneratedRecord
    {
        ...
        [PrimaryKey("ItemId")] public int ItemId { get; set; }
        ...
        public Color[] Colors => new[] {Color1, Color2, Color3, Color4, Color5}.Where(x => x != null)
            .Select(x => Color.FromArgb(x.Value)).ToArray();
    }
}