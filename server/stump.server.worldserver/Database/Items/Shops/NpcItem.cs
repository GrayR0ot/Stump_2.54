...
namespace Stump.Server.WorldServer.Database.Items.Shops
{
    ...
    public class NpcItem : ItemToSell, IAutoGeneratedRecord
    {
        ...
        public NpcItem()
        {
            m_objectItemToSellInNpcShop =
                new ObjectValidator<ObjectItemToSellInNpcShop>(BuildObjectItemToSellInNpcShop);
        }

        public int NpcShopId { get; set; }

        public double Price => CustomPrice.HasValue ? CustomPrice.Value : Item.Price;
        ...
        public double? CustomPrice
        {
            get
            {
                ...
                if ((NpcShopId == 3) | (NpcShopId == 7) | (NpcShopId == 1) | (NpcShopId == 2) | (NpcShopId == 30423) |
                    (NpcShopId == 30424) | (NpcShopId == 30421) | (NpcShopId == 10134) | (NpcShopId == 10131) |
                    (NpcShopId == 151) | (NpcShopId == 30422))
                {
                ...
                else if ((NpcShopId == 21) | (NpcShopId == 23) | (NpcShopId == 14) | (NpcShopId == 4) |
                    (NpcShopId == 5) | (NpcShopId == 6) | (NpcShopId == 8) && Item.TypeId != 23)
                {
                    if (Item.Level <= 200 && Item.Level > 195)
