...
namespace Stump.Server.WorldServer.Database.Items.Templates
{
    ...
    public sealed class ItemTypeRecord : IAssignedByD2O, IAutoGeneratedRecord
    {
        ...
        public ItemTypeEnum ItemType => (ItemTypeEnum) Id;
        ...
        public ItemSuperTypeEnum SuperType => (ItemSuperTypeEnum) SuperTypeId;
        ...
        private void ParseRawZone(string rawZone)
        {
            ...
            var efficiencyZone = ZoneShape == SpellShapeEnum.C || ZoneShape == SpellShapeEnum.X ||
