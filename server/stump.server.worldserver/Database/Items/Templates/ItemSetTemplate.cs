...
namespace Stump.Server.WorldServer.Database.Items.Templates
{
    ...
    public sealed class ItemSetTemplate : IAutoGeneratedRecord, IAssignedByD2O, ISaveIntercepter
    {
        ...
        [Ignore] public ItemTemplate[] Items { get; set; }
        ...
        [Ignore] public List<List<EffectBase>> Effects { get; set; }
        ...
        public void AssignFields(object d2oObject)
        {
            ...
            var effects = itemSet.effects.Select(entry =>
                entry.Where(subentry => subentry != null)
