...
namespace Stump.Server.WorldServer.Database.Items.Templates
{
    ...
    public class ItemTemplate : IAutoGeneratedRecord, IAssignedByD2O, ISaveIntercepter
    {
        ...
        public ItemTypeRecord Type => m_type ?? (m_type = ItemManager.Instance.TryGetItemType((int) TypeId));
        ...
        [NullString] public string Criteria { get; set; }
        ...
        {
            m_possibleEffects =
                m_effects == null ? null : m_effects.Select(entry => entry.GetEffectInstance()).ToList();
