...
namespace Stump.Server.WorldServer.Database.Items.Templates
{
    public class PetTemplateRelator
    {
        public static string FetchQuery =
            "SELECT * FROM items_pets LEFT JOIN items_pets_foods ON items_pets_foods.PetId = items_pets.Id";
    ...
    public class PetTemplate : IAutoGeneratedRecord, IAssignedByD2O, ISaveIntercepter
    {
        ...
        public int MinDurationBeforeMeal { get; set; }

        public int MaxDurationBeforeMeal { get; set; }

        [Ignore] public List<PetFoodRecord> Foods { get; set; } = new List<PetFoodRecord>();

        public byte[] PossibleEffectsBin
        {
            get => m_possibleEffectsBin;
            set
            {
        ...
        public int? GhostItemId { get; set; }
