...
namespace Stump.Server.WorldServer.Database.World
{
    public class WorldMapPaddockRelator : OneToManyRelator<WorldMapPaddockRecord, MountRecord>
    {
        public static string FetchQuery =
            "SELECT * FROM world_maps_paddock LEFT JOIN mounts ON mounts.PaddockId = world_maps_paddock.Id AND world_maps_paddock.GuildId <> NULL";
    }
    ...
    public sealed class WorldMapPaddockRecord : IAutoGeneratedRecord, IOneToManyRecord1<MountRecord>
    {
        ...
        [Ignore] public List<MountRecord> Mounts { get; set; } = new List<MountRecord>();
