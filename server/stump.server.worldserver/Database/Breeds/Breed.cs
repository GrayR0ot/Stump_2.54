...
namespace Stump.Server.WorldServer.Database.Breeds
{
    ...
    public class Breed : IAssignedByD2O, ISaveIntercepter, IAutoGeneratedRecord
    {
        ...
        [Ignore] public string ShortName => m_shortName ?? (m_shortName = TextManager.Instance.GetText(ShortNameId));

        [Ignore] public string LongName => m_longName ?? (m_longName = TextManager.Instance.GetText(LongNameId));

        [Ignore]
        public ActorLook MaleLook
        {
            get => m_maleLook ?? (m_maleLook = ActorLook.Parse(MaleLookString));
            set
            {
                m_maleLook = value;
        ...
        {
            get => m_femaleLook ?? (m_femaleLook = ActorLook.Parse(FemaleLookString));
            set
            {
                m_femaleLook = value;
        ...
        {
            get => m_maleColors ?? (m_maleColors = MaleColorsCSV.FromCSV<uint>(","));
            set
            {
                m_maleColors = value;
        ...
        {
            get => m_femaleColors ?? (m_femaleColors = FemaleColorsCSV.FromCSV<uint>(","));
            set
            {
        ...
        {
            get => m_breedSpellsId ?? (m_breedSpellsId = BreedSpellsIdCSV.FromCSV<uint>(","));
            set
            {
        ...
        public short TombBonesId { get; set; }

        public short MaleGhostBonesId { get; set; }

        public short FemaleGhostBonesId { get; set; }
        ...
        {
            get => m_statsPointsForStrengthCSV;
            set
            {
        ...
        {
            get => m_statsPointsForIntelligenceCSV;
            set
            {
        ...
        {
            get => m_statsPointsForAgilityCSV;
            set
            {
        ...
        {
            get => m_statsPointsForVitalityCSV;
            set
            {
        ...
        public short StartCell { get; set; }

        public DirectionsEnum StartDirection { get; set; }

        public int StartActionPoints { get; set; }

        public int StartMovementPoints { get; set; }

        public int StartHealthPoint { get; set; }

        public int StartProspection { get; set; }

        public ushort StartStatsPoints { get; set; }

        public ushort StartSpellsPoints { get; set; }

        public short StartStrength { get; set; }

        public short StartVitality { get; set; }

        public short StartWisdom { get; set; }

        public short StartIntelligence { get; set; }

        public short StartChance { get; set; }

        public short StartAgility { get; set; }

        public short StartLevel { get; set; }

        public ulong StartKamas { get; set; }

        [Ignore] public List<BreedItem> Items { get; set; }

        [Ignore] public List<BreedSpell> Spells { get; set; }
