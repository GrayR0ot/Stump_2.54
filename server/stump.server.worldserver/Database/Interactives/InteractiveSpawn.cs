...
namespace Stump.Server.WorldServer.Database.Interactives
{
    public class InteractiveSpawnRelator
    {
        ...
        public InteractiveSpawn Map(InteractiveSpawn spawn, InteractiveSpawnSkills binding,
    ...
    public class InteractiveSpawnSkills : IAutoGeneratedRecord
    {
        ...
        [Column("InteractiveSpawnId")] [Index] public int InteractiveSpawnId { get; set; }
    ...
    public class InteractiveSpawn : IAutoGeneratedRecord
    {
        ...
        [Ignore]
        public InteractiveTemplate Template => TemplateId.HasValue
            ? m_template ?? (m_template = InteractiveManager.Instance.GetTemplate(TemplateId.Value))
            : null;
        ...
        /// </summary>
        [Ignore]
        public List<ISkillRecord> CustomSkills { get; set; }
