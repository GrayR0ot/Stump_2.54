...
namespace Stump.Server.WorldServer.Database.Interactives
{
    public class InteractiveTemplateRelator
    {
        ...
        private readonly Dictionary<int, InteractiveTemplate> m_currentMapping =
            new Dictionary<int, InteractiveTemplate>();

        private InteractiveTemplate m_current;

        public InteractiveTemplate Map(InteractiveTemplate template, InteractiveSkillTemplate skillTemplate,
            InteractiveTemplateSkills binding,
    ...
    public class InteractiveTemplateSkills : IAutoGeneratedRecord
    {
        ...
        [Column("InteractiveTemplateId")]
        [Index]
        public int InteractiveTemplateId { get; set; }

        [Column("SkillId")] public int SkillId { get; set; }
    }
    ...
    public class InteractiveTemplate : IAssignedByD2O, IAutoGeneratedRecord
    {
        ...
        public InteractiveTypeEnum Type => (InteractiveTypeEnum) Id;
        ...
        [Ignore]
        public List<InteractiveSkillTemplate> TemplateSkills { get; set; } = new List<InteractiveSkillTemplate>();

        [Ignore]
        public List<InteractiveCustomSkillRecord> CustomSkills { get; set; } = new List<InteractiveCustomSkillRecord>();
