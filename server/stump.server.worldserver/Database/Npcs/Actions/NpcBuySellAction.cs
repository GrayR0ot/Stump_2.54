...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuySellAction : NpcActionDatabase
    {
        ...
        public int TokenId
        {
            get => Record.GetParameter<int>(0, true);
            set => Record.SetParameter(0, value);
        }

        public ItemTemplate Token
        {
            get => TokenId > 0 ? m_token ?? (m_token = ItemManager.Instance.TryGetTemplate(TokenId)) : null;
            set
            {
                m_token = value;
        ...
        public bool CanSell
        {
            get => Record.GetParameter<int>(1, true) == 1;
        ...
        {
            get => Record.GetParameter<int>(2, true) == 1;
        ...
        public override NpcActionTypeEnum[] ActionType
        {
            ...
            {
                return new[]
                    {NpcActionTypeEnum.ACTION_BUY_SELL, NpcActionTypeEnum.ACTION_SELL, NpcActionTypeEnum.ACTION_BUY};
            }
        }
