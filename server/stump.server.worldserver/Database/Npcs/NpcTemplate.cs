...
namespace Stump.Server.WorldServer.Database.Npcs
{
    ...
    public class NpcTemplate : IAssignedByD2O, ISaveIntercepter, IAutoGeneratedRecord
    {
        ...
        [Ignore] public int[][] DialogMessagesId { get; set; }

        public string DialogRepliesIdCSV
        {
            get => m_dialogRepliesIdCSV;
            set
            {
        ...
        [Ignore] public int[][] DialogRepliesId { get; set; }
        ...
        [Ignore] public uint[] ActionsIds { get; set; }

        public List<NpcActionDatabase> Actions => m_actions ?? (m_actions = NpcManager.Instance.GetNpcActions(Id));
