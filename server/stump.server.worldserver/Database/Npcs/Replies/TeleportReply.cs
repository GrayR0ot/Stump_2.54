...
namespace Stump.Server.WorldServer.Database.Npcs.Replies
{
    ...
    public class TeleportReply : NpcReply
    {
        ...
        {
            get => (DirectionsEnum) Record.GetParameter<int>(2);
            set
            {
        ...
        {
            get => Record.GetParameter<string>(3, true);
        ...
        {
            get => Record.GetParameter<ulong>(4, true);
            set => Record.SetParameter(4, value);
        }
        ...
        public override bool CanShow(Npc npc, Character character)
        {
            return base.CanShow(npc, character) && MapId != character.Map.Id;
        }
        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            if (ItemsParameter != null)
            {
                ...
                {
                    if (!int.TryParse(itemParameter[0], out var itemId))
                        return false;

                    if (!int.TryParse(itemParameter[1], out var amount))
                        return false;
