...
namespace Stump.Server.WorldServer.Database.Monsters
{
    ...
    public class MonsterStaticSpawnEntity : IAutoGeneratedRecord
    {
        ...
        [Index] public int StaticSpawnId { get; set; }
    ...
    public class MonsterStaticSpawn : IAutoGeneratedRecord
    {
        ...
        public Cell Cell
        {
            get => m_cell ?? (m_cell = Map.GetCell(CellId));
            set
            {
                m_cell = value;
                CellId = value.Id;
        ...
        [NullString] public int TpMapId { get; set; }

        [Ignore]
        public Map TpMap
        {
            get => m_tpmap ?? (m_tpmap = Game.World.Instance.GetMap(TpMapId));
            set
            {
                m_tpmap = value;
                TpMapId = value.Id;
        ...
        [NullString] public int TpCellId { get; set; }

        [Ignore]
        public Cell TpCell
        {
            get => m_tpcell ?? (m_tpcell = Map.GetCell(TpCellId));
            set
            {
                m_tpcell = value;
                TpCellId = value.Id;
        ...
        [NullString] public uint? TpDirection { get; set; }

        [Ignore] public List<MonsterGrade> GroupMonsters { get; set; }
    }
}