...
namespace Stump.Server.WorldServer.Database.Monsters
{
    ...
    public class MonsterDungeonSpawnEntity : IAutoGeneratedRecord
    {
        ...
        public int PossibleMonsterGradeIdsCSV { get; set; }
    ...
    public class MonsterDungeonSpawn : IAutoGeneratedRecord
    {
        ...
        [Ignore] public List<MonsterDungeonSpawnEntity> GroupMonsters { get; set; }
    ...
    public class MonsterDungeonWaveSpawnEntity : IAutoGeneratedRecord
    {
        ...
        public MonsterDungeonWaveSpawnEntity(MonsterDungeonSpawn group, MonsterGrade grade, int? waveNumber,
            int? minPLayer = null)
        {
            DungeonSpawnId = group.Id;
            MonsterGrade = grade;
