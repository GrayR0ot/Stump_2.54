...
namespace Stump.Server.WorldServer.Database.Quests
{
    ...
    public class QuestRewardTemplate : IAutoGeneratedRecord, IAssignedByD2O
    {
        ...
        {
            get => m_itemsReward ?? (m_itemsReward = ItemsRewardCSV.FromCSV<int>(","));
            set
            {
                m_itemsReward = value;
        ...
        {
            get => m_itemQuantitiesReward ?? (m_itemQuantitiesReward = ItemQuantitiesRewardCSV.FromCSV<int>(","));
            set
            {
        ...
        {
            get => m_emotesReward ?? (m_emotesReward = EmotesRewardCSV.FromCSV<int>(","));
            set
            {
        ...
        {
            get => m_jobsReward ?? (m_jobsReward = JobsRewardCSV.FromCSV<int>(","));
            set
            {
                m_jobsReward = value;
        ...
        {
            get => m_spellsReward ?? (m_spellsReward = SpellsRewardCSV.FromCSV<int>(","));
            set
            {
