...
using QuestObjective = Stump.Server.WorldServer.Game.Quests.QuestObjective;
...
namespace Stump.Server.WorldServer.Database.Quests
{
    ...
    public class QuestObjectiveTemplate : IAutoGeneratedRecord, IAssignedByD2O
    {
        ...
        {
            get => m_parameters ?? (m_parameters = ParametersCSV.FromCSV<int>(","));
            set
            {
                m_parameters = value;
        ...
        [Ignore] public QuestObjectiveType RealType { get; set; }

        [Ignore] public QuestObjectiveTemplate[] ObjectivesToTrigger { get; set; }

        public void AssignFields(object d2oObject)
        {
            var objective = (DofusProtocol.D2oClasses.QuestObjective) d2oObject;
            Id = (int) objective.Id;
        ...
        public QuestObjective GenerateObjective(Character character)
        {
            switch (Type)
            {
                case QuestObjectiveTypeEnum.BRING_SOULS_TO:
                    return new BringSoulsToObjective(character, this, false, Parameter0, Parameter1,
                        Parameter2); // Parameter0 = NpcId, Parameter1 = MonsterId, Parameter2 = quantity
        ...
        public QuestObjective GenerateObjective(Character character, QuestObjectiveStatus status)
        {
            switch (Type)
            {
                case QuestObjectiveTypeEnum.BRING_SOULS_TO:
                ...
                case QuestObjectiveTypeEnum.BRING_ITEMS_TO:
                    return new BringItemsToObjective(character, this, status, Parameter0, Parameter2, Parameter1,
                        false);
                case QuestObjectiveTypeEnum.GIVE_ITEMS_TO:
