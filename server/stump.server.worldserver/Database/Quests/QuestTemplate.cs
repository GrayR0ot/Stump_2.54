...
namespace Stump.Server.WorldServer.Database.Quests
{
    ...
    public class QuestTemplate : IAssignedByD2O, IAutoGeneratedRecord
    {
        ...
        public int[] StepIds
        {
            get => m_stepIds ?? (m_stepIds = StepIdsCSV.FromCSV<int>(","));
            set
            {
                m_stepIds = value;
        ...
        {
            get => m_startCriterion ?? (m_startCriterion = ConditionExpression.Parse(StartCriterionStr));
            set
            {
