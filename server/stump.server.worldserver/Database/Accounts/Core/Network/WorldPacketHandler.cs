...
{
    public class WorldPacketHandler : HandlerManager<WorldPacketHandler, WorldHandlerAttribute, WorldHandlerContainer,
        WorldClient>
    {
        ...
        {
            if (!attr.IsGamePacket) return WorldServer.Instance.IOTaskPool;
