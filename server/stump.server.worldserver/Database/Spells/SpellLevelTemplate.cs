...
namespace Stump.Server.WorldServer.Database.Spells
{
    ...
    public class SpellLevelTemplate : IAssignedByD2O, ISaveIntercepter, IAutoGeneratedRecord
    {
        ...
        private String m_criticalEffectsJson;
        ...
        public String CriticalEffectsJson
        {
            get => m_criticalEffectsJson;
            set
            {
                m_criticalEffectsJson = value;
            }
        }
        ...
        public List<EffectDice> Effects
        {
            get
            {
                ...
                else
                {
                    ...
                    JArray jArray = JArray.Parse(EffectsJson);
        ...
        public void AssignFields(object d2oObject)
        {
            ...
            m_effectsJson = EffectManager.Instance.SerializeEffectsToJson(spell.effects);
            m_criticalEffectsJson = EffectManager.Instance.SerializeEffectsToJson(spell.criticalEffect);
        }
