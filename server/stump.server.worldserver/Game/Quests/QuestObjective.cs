...
namespace Stump.Server.WorldServer.Game.Quests
{
    public abstract class QuestObjective
    {
        ...
        public QuestObjectiveStatus ObjectiveRecord { get; set; }

        public QuestObjectiveTemplate Template { get; }
        ...
        public QuestStepTemplate StepTemplate => QuestManager.Instance.GetQuestStep(Template.StepId);
        ...
        protected virtual void OnCompleted()
        {
            ...
            ContextRoleplayHandler.SendRefreshMapQuestWithout(Character.Client,
                QuestManager.Instance.GetQuestTemplateWithStepId(Template.StepId).Id);
            ContextRoleplayHandler.SendQuestStepValidatedMessage(Character.Client,
                (ushort) QuestManager.Instance.GetQuestTemplateWithStepId(Template.StepId).Id,
                (ushort) Template.StepId);
        }
        ...
        public void Save(ORM.Database database)
        {
            WorldServer.Instance.IOTaskPool.ExecuteInContext(() =>
            {
                ...
                if (objectives.Any(x =>
                    x.ObjectiveId == ObjectiveRecord.ObjectiveId &&
                    x.QuestId == ObjectiveRecord.QuestId)) // On vérifie si y'a déjà un record contenant la quêteId
