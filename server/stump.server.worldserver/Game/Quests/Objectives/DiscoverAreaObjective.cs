...
namespace Stump.Server.WorldServer.Game.Quests.Objectives
{
    ...
    {
        public DiscoverAreaObjective(Character character, QuestObjectiveTemplate template, bool finished, int subAreaId)
            : base(character, template, finished)
        {
            SubArea = World.Instance.GetSubArea(subAreaId);
        }

        public DiscoverAreaObjective(Character character, QuestObjectiveTemplate template,
            QuestObjectiveStatus finished, int subAreaId) : base(character, template, finished)
        {
            SubArea = World.Instance.GetSubArea(subAreaId);
        }
