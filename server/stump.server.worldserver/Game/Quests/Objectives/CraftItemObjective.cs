...
namespace Stump.Server.WorldServer.Game.Quests.Objectives
{
    public class CraftItemObjective : QuestObjective
    {
        ...
        public CraftItemObjective(Character character, QuestObjectiveTemplate template, bool finished, int itemId,
            int amount)
        ...
        public CraftItemObjective(Character character, QuestObjectiveTemplate template, QuestObjectiveStatus finished,
