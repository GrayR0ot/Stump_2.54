...
namespace Stump.Server.WorldServer.Game.Quests.Objectives
{
    ...
    {
        public BringItemsToObjective(Character character, QuestObjectiveTemplate template, bool finished, int npcId,
            int amount, int itemId, bool delete)
        ...
        public BringItemsToObjective(Character character, QuestObjectiveTemplate template, QuestObjectiveStatus status,
            int npcId, int amount, int itemId, bool delete)
