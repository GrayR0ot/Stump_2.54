...
namespace Stump.Server.WorldServer.Game.Quests.Objectives
{
    ...
    {
        public BringSoulsToObjective(Character character, QuestObjectiveTemplate template, bool finished, int npcId,
            int monsterId, int amount)
        ...
        public BringSoulsToObjective(Character character, QuestObjectiveTemplate template, QuestObjectiveStatus status,
            int npcId, int monsterId, int amount)
        ...
        public NpcTemplate Npc { get; set; }

        public int Amount { get; set; }

        public MonsterTemplate Monster { get; set; }
        ...
        private void CharacterOnInteractingWith(Character character, Npc npc, NpcActionTypeEnum actionType,
            NpcAction action)
        {
        ...
        {
            return new QuestObjectiveInformations((ushort) Template.Id, ObjectiveRecord.Status ? false : true,
                new string[0]);
        }
