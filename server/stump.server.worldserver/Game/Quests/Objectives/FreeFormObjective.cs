...
namespace Stump.Server.WorldServer.Game.Quests.Objectives
{
    ...
    {
        public FreeFormObjective(Character character, QuestObjectiveTemplate template, bool finished) : base(character,
            template, finished)
        {
        }

        public FreeFormObjective(Character character, QuestObjectiveTemplate template, QuestObjectiveStatus finished) :
