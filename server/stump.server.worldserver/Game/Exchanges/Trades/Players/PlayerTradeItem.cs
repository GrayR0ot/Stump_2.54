...
namespace Stump.Server.WorldServer.Game.Exchanges.Trades.Players
{
    public class PlayerTradeItem : TradeItem
    {
        ...
        public Exchanger Trader { get; }

        public Character Owner => PlayerItem.Owner;

        public BasePlayerItem PlayerItem { get; }

        public override int Guid => PlayerItem.Guid;

        public override ItemTemplate Template => PlayerItem.Template;
        ...
        public override List<EffectBase> Effects => PlayerItem.Effects;
