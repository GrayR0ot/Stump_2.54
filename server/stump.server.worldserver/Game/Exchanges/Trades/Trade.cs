...
namespace Stump.Server.WorldServer.Game.Exchanges.Trades
{
    ...
    {
        public TFirst FirstTrader { get; protected set; }

        public TSecond SecondTrader { get; protected set; }

        Trader ITrade.FirstTrader => FirstTrader;

        Trader ITrade.SecondTrader => SecondTrader;
