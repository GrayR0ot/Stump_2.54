...
namespace Stump.Server.WorldServer.Game.Exchanges.Craft
{
    public class MultiCraftRequest : RequestBox
    {
        ...
        {
            InventoryHandler.SendExchangeOkMultiCraftMessage(Source.Client, Source, Target,
                ExchangeTypeEnum.MULTICRAFT_CRAFTER);
            InventoryHandler.SendExchangeOkMultiCraftMessage(Target.Client, Source, Source,
