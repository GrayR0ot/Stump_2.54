...
namespace Stump.Server.WorldServer.Game.Exchanges.TaxCollector
{
    ...
    {
        public CharacterCollector(TaxCollectorNpc taxCollector, Character character,
            TaxCollectorExchange taxCollectorTrade)
        ...
        public Dictionary<int, TaxCollectorItem> RecoltedItems { get; }
        ...
        public override bool MoveItem(uint id, int quantity)
        {
            ...
            if (TaxCollector.Bag.MoveToInventory(taxCollectorItem, Character, quantity))
            {
                if (RecoltedItems.ContainsKey(taxCollectorItem.Guid))
                    ...
                    RecoltedItems.Add(taxCollectorItem.Guid,
                        ItemManager.Instance.CreateTaxCollectorItem(TaxCollector, taxCollectorItem.Template, quantity));
