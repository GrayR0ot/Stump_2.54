...
{
    [Discriminator("ZaapiTeleport", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord),
    ...
    public class SkillZaapiTeleport : CustomSkill
    {
        ...
        {
            return base.IsEnabled(character) && Record.AreConditionsFilled(character);
        }
