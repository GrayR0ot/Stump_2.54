...
{
    [Discriminator("ReadDocument", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord),
        typeof(InteractiveObject))]
    public class SkillReadDocument : CustomSkill
    {
        public SkillReadDocument(int id, InteractiveCustomSkillRecord skillTemplate,
