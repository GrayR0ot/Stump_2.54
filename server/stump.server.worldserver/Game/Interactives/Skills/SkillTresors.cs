...
{
    [Discriminator("Tresors", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord),
    ...
    public class SkillTresors : CustomSkill
    {
        ...
        public int Level
        {
            get => m_Level ?? (m_Level = Record.GetParameter<int>(0)).Value;
            set
            {
        ...
        public override int StartExecute(Character character)
        {
            ...
            if (character.Record.TreasureSearch == 0)
            {
                ...
                var rndNumbers = new Random();
                var rndNumbers_2 = new Random();
                //Astrub + Bonta + Brakmar
                var rndNumber = 0;
                var rndNumber_2 = 0;
                ...
                if (rndNumber == 1)
                {
                    ...
                    character.DisplayNotification("Vous êtes maintenant à la recherche d'un trésor.");
            ...
            else
            {
                character.SendServerMessage(
                    "Vous ne pouvez avoir deux chasses au trésor de même type simultanément. Vous devez abandonner l'ancienne avant d'en prendre une nouvelle.");
            }
