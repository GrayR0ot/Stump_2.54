...
namespace Stump.Server.WorldServer.Game.Dialogs.Npcs
{
    public class NpcShopDialog : IShopDialog
    {
        ...
        public IEnumerable<NpcItem> Items { get; protected set; }

        public ItemTemplate Token { get; protected set; }
        ...
        public virtual bool BuyItem(uint itemId, uint amount)
        {
            ...
            var item = ItemManager.Instance.CreatePlayerItem(Character, (int) itemId, (int) amount,
                MaxStats || itemToSell.MaxStats);
            ...
            else
            {
                ...
                Character.SendInformationMessage(TextInformationTypeEnum.TEXT_INFORMATION_MESSAGE, 252,
                    item.Template.Id, item.Guid, item.Stack, finalPrice);
            }
