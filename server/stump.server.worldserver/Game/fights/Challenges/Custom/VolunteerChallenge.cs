...
namespace Stump.Server.WorldServer.Game.Fights.Challenges.Custom
{
    ...
    [ChallengeIdentifier((int)ChallengeEnum.GOURLO_LE_TERRIBLE__CHALLENGE_1_)]
    [ChallengeIdentifier((int)ChallengeEnum.GROZILLA_ET_GRASMERA_ÉPUISÉS__CHALLENGE_1_)]
