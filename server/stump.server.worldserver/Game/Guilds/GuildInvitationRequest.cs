...
namespace Stump.Server.WorldServer.Game.Guilds
{
    public class GuildInvitationRequest : RequestBox
    {
        ...
        {
            GuildHandler.SendGuildInvitationStateRecruterMessage(Source.Client, Target,
                GuildInvitationStateEnum.GUILD_INVITATION_SENT);
            GuildHandler.SendGuildInvitationStateRecrutedMessage(Target.Client,
                GuildInvitationStateEnum.GUILD_INVITATION_SENT);
        ...
        protected override void OnDeny()
        {
            ...
            GuildHandler.SendGuildInvitationStateRecruterMessage(Target.Client, Target,
                GuildInvitationStateEnum.GUILD_INVITATION_CANCELED);
        }
