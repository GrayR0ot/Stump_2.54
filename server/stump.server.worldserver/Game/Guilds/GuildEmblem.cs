...
namespace Stump.Server.WorldServer.Game.Guilds
{
    public class GuildEmblem
    {
        ...
        public GuildRecord Record { get; }

        public EmblemRecord Template { get; private set; }

        public short BackgroundShape
        {
            get => Record.EmblemBackgroundShape;
            set
            {
        ...
        {
            get => m_backgroundColor ?? (m_backgroundColor = Color.FromArgb(Record.EmblemBackgroundColor)).Value;
            set
            {
        ...
        {
            get => Record.EmblemForegroundShape;
            set
            {
        ...
        {
            get => m_foregroundColor ?? (m_foregroundColor = Color.FromArgb(Record.EmblemForegroundColor)).Value;
            set
            {
