...
namespace Stump.Server.WorldServer.Game.Achievements
{
    public class AchievementManager : DataManager<AchievementManager>
    {
        ...
        private Dictionary<MonsterTemplate, List<IdolsScoreCriterion>> m_idolsScoresCriterions;
        ...
        public JobLevelCriterion MinJobLevelCriterion =>
            IncrementableCriterion[typeof(JobLevelCriterion)] as JobLevelCriterion;

        public AchievementPointsCriterion MinAchievementPointsCriterion
            => IncrementableCriterion[typeof(AchievementPointsCriterion)] as AchievementPointsCriterion;

        public CraftCountCriterion CraftCountCriterion
            => IncrementableCriterion[typeof(CraftCountCriterion)] as CraftCountCriterion;

        public DecraftCountCriterion DecraftCountCriterion
            => IncrementableCriterion[typeof(DecraftCountCriterion)] as DecraftCountCriterion;

        public ChallengeCountCriterion ChallengeCountCriterion
            => IncrementableCriterion[typeof(ChallengeCountCriterion)] as ChallengeCountCriterion;

        public ChallengeInDungeonCountCriterion ChallengeInDungeonCountCriterion
            => IncrementableCriterion[typeof(ChallengeInDungeonCountCriterion)] as ChallengeInDungeonCountCriterion;

        public QuestFinishedCountCriterion QuestFinishedCountCriterion
            => IncrementableCriterion[typeof(QuestFinishedCountCriterion)] as QuestFinishedCountCriterion;
        ...
        public override void Initialize()
        {
            ...
            m_idolsScoresCriterions = new Dictionary<MonsterTemplate, List<IdolsScoreCriterion>>();
            ...
            foreach (var pair in m_achievementsTemplates) pair.Value.Initialize();
            foreach (var pair in m_achievementsObjectives) pair.Value.Initialize();
        }
        ...
        public void AddCriterion(AbstractCriterion criterion)
        {
            ...
            if (criterion.IsIncrementable) AddIncrementableCriterion(criterion);
        }
        ...
        public bool AddIdolsScoreCriterion(IdolsScoreCriterion criterion)
        {
            if (m_idolsScoresCriterions.ContainsKey(criterion.Monster))
            {
                m_idolsScoresCriterions[criterion.Monster].Add(criterion);
            }
            else
            {
                var list = new List<IdolsScoreCriterion>();
                list.Add(criterion);
                m_idolsScoresCriterions.Add(criterion.Monster, list);
                return true;
            }
        ...
        public List<IdolsScoreCriterion> TryGetIdolsScoreCriterionByMonster(MonsterTemplate template)
        {
            return m_idolsScoresCriterions.ContainsKey(template) ? m_idolsScoresCriterions[template] : null;
            //return m_idolsScoresCriterions.ContainsKey(template) ? m_idolsScoresCriterions.Where(x => x.Key == template).Select(y => y.Value) : null;
        }
        ...
        {
            return m_killBossWithChallengeCriterion.ContainsValue(template)
                ? m_killBossWithChallengeCriterion.Where(x => x.Value == template).Select(y => y.Key)
                : null;
        }
    }
}