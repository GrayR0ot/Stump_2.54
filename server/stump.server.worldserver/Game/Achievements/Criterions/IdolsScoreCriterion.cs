...
namespace Stump.Server.WorldServer.Game.Achievements.Criterions
{
        ...
        AbstractCriterion<IdolsScoreCriterion, DefaultCriterionData>
    {
        ...
        {
            Console.WriteLine("Current score: " + character.Fighter.Fight.GetIdolsScore());
        ...
        {
            Console.WriteLine("Current score: " + (ushort) Math.Min(0, player.GetRunningCriterion(this)));
