        ...
        AbstractCriterion<KillBossWithChallengeCriterion, DefaultCriterionData>
    {
        ...
        public int GetMonsterIdByChallId(int id)
        {
            switch (id)
            {
                ...
                case (int) ChallengeEnum.GOURLO_LE_TERRIBLE__CHALLENGE_1_:
                case (int) ChallengeEnum.GOURLO_LE_TERRIBLE__CHALLENGE_2_:
                case (int) ChallengeEnum.GOURLO_LE_TERRIBLE__CHALLENGE_DUO_:
                    return (int) MonsterIdEnum.GOURLO_LE_TERRIBLE;

                case (int) ChallengeEnum.HALOUINE__CHALLENGE_1_:
                case (int) ChallengeEnum.HALOUINE__CHALLENGE_2_:
                case (int) ChallengeEnum.HALOUINE__CHALLENGE_CHRONO_:
                case (int) ChallengeEnum.HALOUINE__CHALLENGE_DUO_:
                    return (int) MonsterIdEnum.HALOUINE;

                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_FATIGUÉS__CHALLENGE_1_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_FATIGUÉS__CHALLENGE_2_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_FATIGUÉS__CHALLENGE_CHRONO_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_FATIGUÉS__CHALLENGE_DUO_:
                    return (int) MonsterIdEnum.GROZILLA_FATIGUE;

                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_SOMNAMBULES__CHALLENGE_1_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_SOMNAMBULES__CHALLENGE_2_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_SOMNAMBULES__CHALLENGE_CHRONO_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_SOMNAMBULES__CHALLENGE_DUO_:
                    return (int) MonsterIdEnum.GROZILLA_SOMNAMBULE;

                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_ÉPUISÉS__CHALLENGE_1_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_ÉPUISÉS__CHALLENGE_2_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_ÉPUISÉS__CHALLENGE_CHRONO_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA_ÉPUISÉS__CHALLENGE_DUO_:
                    return (int) MonsterIdEnum.GRASMERA_EPUISE;

                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA__CHALLENGE_1__285:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA__CHALLENGE_1__286:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA__CHALLENGE_CHRONO_:
                case (int) ChallengeEnum.GROZILLA_ET_GRASMERA__CHALLENGE_DUO_:
