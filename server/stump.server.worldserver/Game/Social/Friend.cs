        ...
        public FriendInformations GetFriendInformations(Character asker)
        {
            ...
            if (hvb == null && IsOnline())
                return new FriendOnlineInformations(Account.Id,
                    Account.Nickname,
                    (sbyte) (Character.FriendsBook.IsFriend(asker.Account.Id)
                        ? Character.IsFighting() ? PlayerStateEnum.GAME_TYPE_FIGHT : PlayerStateEnum.GAME_TYPE_ROLEPLAY
                        : PlayerStateEnum.UNKNOWN_STATE),
                    ...
                    Character.FriendsBook.IsFriend(asker.Account.Id)
                        ? (sbyte) Character.AlignmentSide
                        : (sbyte) AlignmentSideEnum.ALIGNMENT_UNKNOWN,
                    (sbyte) Character.Breed.Id,
                    Character.GuildMember == null
                        ? new GuildInformations(0, "", 0, new GuildEmblem(0, 0, 0, 0))
                        : Character.GuildMember.Guild.GetGuildInformations(),
