...
namespace Stump.Server.WorldServer.Game.Arena
{
    public class ArenaPreFightTeam
    {
        ...
        public ArenaPreFight Fight { get; }

        public int MissingMembers => ArenaManager.MaxPlayersPerFights - m_members.Count;

        public ReadOnlyCollection<ArenaWaitingCharacter> Members => m_members.AsReadOnly();
