...
namespace Stump.Server.WorldServer.Game.Arena
{
    public class ArenaPopup : Notification
    {
        ...
        public ArenaWaitingCharacter WaitingCharacter { get; }

        public Character Character => WaitingCharacter.Character;

        public ArenaPreFightTeam Team => WaitingCharacter.Team;

        public ArenaPreFight Fight => Team.Fight;
