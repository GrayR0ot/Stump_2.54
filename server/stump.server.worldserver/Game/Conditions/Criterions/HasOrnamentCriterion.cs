    ...
    public class HasOrnamentCriterion : Criterion
    {
        ...
        public override bool Eval(Character character)
        {
            return Operator == ComparaisonOperatorEnum.EQUALS
                ? character.HasOrnament(Ornament)
                : !character.HasOrnament(Ornament);
        }
        ...
        public override void Build()
        {
            ...
            if (!short.TryParse(Literal, out ornament))
                throw new Exception(string.Format("Cannot build HasOrnamentCriterion, {0} is not a valid ornament",
                    Literal));
