...
namespace Stump.Server.WorldServer.Game.Conditions.Criterions
{
    public class HasItemCriterion : Criterion
    {
        ...
        public override bool Eval(Character character)
        {
            ...
            return Operator == ComparaisonOperatorEnum.INEQUALS &&
                   !character.Inventory.Any(entry => entry.Template.Id == Item && entry.IsEquiped());
        }
        ...
        public override void Build()
        {
            ...
            if (!int.TryParse(Literal, out itemId))
                throw new Exception(string.Format("Cannot build HasItemCriterion, {0} is not a valid item id",
                    Literal));
