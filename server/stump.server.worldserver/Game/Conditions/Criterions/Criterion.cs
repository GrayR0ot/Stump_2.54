...
namespace Stump.Server.WorldServer.Game.Conditions.Criterions
{
    ...
    {
        public ComparaisonOperatorEnum Operator { get; set; }
        ...
        protected bool Compare(object obj, object comparand)
        {
            switch (Operator)
            {
                ...
                default:
                    throw new NotImplementedException(string.Format("Cannot use {0} comparator on objects {1} and {2}",
                        Operator, obj, comparand));
            }
        }
            ...
            switch (Operator)
            {
                ...
                default:
                    throw new NotImplementedException(
                        string.Format("Cannot use {0} comparator on IComparable {1} and {2}", Operator, obj,
                            comparand));
            }
        }
        ...
        protected bool Compare(string str, string comparand)
        {
            switch (Operator)
            {
                ...
                default:
                    throw new NotImplementedException(
                        string.Format("Cannot use {0} comparator on strings '{1}' and '{2}'", Operator, str,
                            comparand));
            }
        }
