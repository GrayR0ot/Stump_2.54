...
namespace Stump.Server.WorldServer.Game.Conditions.Criterions
{
    public class StatsCriterion : Criterion
    {
        ...
        private static readonly Dictionary<string, PlayerFields> CriterionsStatsBaseBinds =
            new Dictionary<string, PlayerFields>
            {
                {"Ca", PlayerFields.Agility},
                {"Cc", PlayerFields.Chance},
                {"Cs", PlayerFields.Strength},
        ...
        private static readonly Dictionary<string, PlayerFields> CriterionsStatsAdditionalBinds =
            new Dictionary<string, PlayerFields>
            {
                {"ca", PlayerFields.Agility},
                {"cc", PlayerFields.Chance},
        ...
        public PlayerFields? Field { get; set; }
        ...
        {
            return CriterionsBinds.ContainsKey(identifier) || CriterionsStatsBaseBinds.ContainsKey(identifier) ||
                   CriterionsStatsAdditionalBinds.ContainsKey(identifier) ||
                   ExtraCriterions.Any(entry => entry == identifier);
        }
        ...
        public override bool Eval(Character character)
        {
            ...
            if (Field.HasValue)
                return Compare(Base ? character.Stats[Field.Value].Base :
                    Additional ? character.Stats[Field.Value].Additional : character.Stats[Field.Value].Total,
                    Comparand);
            ...
            switch (Identifier)
            {
                ...
                case "CH":
                    return true; // honnor
                default:
                    throw new Exception(string.Format("Cannot eval StatsCriterion {0}, {1} is not a stats identifier",
                        this, Identifier));
            }
        }
        ...
        public override void Build()
        {
            ...
            {
                throw new Exception(string.Format("Cannot build StatsCriterion, {0} is not a stats identifier",
                    Identifier));
            }
