            ...
            switch (effect.EffectId)
            {
                ...
                case EffectsEnum.Effect_2794:
                    ...
                    if (spell.Effects.Any(x =>
                        (x.EffectId == EffectsEnum.Effect_TriggerBuff ||
                         x.EffectId == EffectsEnum.Effect_TriggerBuff_793 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1017 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1160 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1175 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_2160 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1017 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1160 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1175 || x.EffectId == EffectsEnum.Effect_2792 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1017 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1160 ||
                         x.EffectId == EffectsEnum.Effect_CastSpell_1175 || x.EffectId == EffectsEnum.Effect_2794) &&
