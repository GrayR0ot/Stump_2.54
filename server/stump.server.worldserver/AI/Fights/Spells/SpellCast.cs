...
namespace Stump.Server.WorldServer.AI.Fights.Spells
{
    public class AISpellCastPossibility
    {
        ...
        public TargetCell TargetCell => Target.Target;

        public Path MoveBefore { get; set; }

        public int MPCost => MoveBefore != null ? MoveBefore.MPCost : 0;

        public Path MoveAfter { get; set; }

        public int MaxConsecutiveCast { get; set; }
    }
}