...
namespace Stump.Server.WorldServer.AI.Fights.Actions
{
    ...
    {
        public const int MaxMovesTries = 50;
        ...
        public Cell DestinationCell { get; }

        public MapPoint Destination { get; }

        public short DestinationId => Destination == null ? DestinationCell.Id : Destination.CellId;

        public bool AttemptOnly { get; set; }
        ...
        protected override RunStatus Run(object context)
        {
            ...
            while (success && Fighter.Cell.Id != DestinationId && Fighter.CanMove() && tries <= MaxMovesTries)
            {
                ...
                if (path == null || path.IsEmpty()) return RunStatus.Failure;

                if (path.MPCost > Fighter.MP) return RunStatus.Failure;
